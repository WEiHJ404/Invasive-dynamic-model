...
# PARAMETERS --------------------------------------------------------------
rm(list = ls())
beta <- read.xlsx('/Users/weihj/Desktop/工作/2022/0405/上海/上海参数.xlsx', sheet = 4, cols = 1:3, colNames = T)
b <- c(beta$b)
h <- c(beta$h)
bb <- c(beta$bb)
t1 <- seq(22, 44, 2)
# setwd('./shanghai_output/')

for (t in t1) {
        # dir.create(as.character(t))
        for (i in seq_along(b)) {
                ...
                write.xlsx(out, paste0("/Users/weihj/Desktop/工作/2022/0413/上海/bh/",t, "/", b[i], '_', h[i], '.xlsx'),overwrite = TRUE)
                rm(out)
