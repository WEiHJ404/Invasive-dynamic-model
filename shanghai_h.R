...
# PARAMETERS --------------------------------------------------------------
rm(list = ls())
beta <- read.xlsx('/Users/weihj/Desktop/工作/2022/0405/上海/上海参数.xlsx', sheet = 2, cols = 1:3, colNames = T)
b <- c(beta$b)
h <- c(beta$h)
bb <- c(beta$bb)
t1 <- seq(22, 44, 2)
...
for (t in t1) {
  ...
  for (i in seq_along(h)) {
    ...
    write.xlsx(out, paste0("/Users/weihj/Desktop/工作/2022/0413/上海/h/",t, "/", h[i], '.xlsx'),overwrite = TRUE)
    rm(out)
