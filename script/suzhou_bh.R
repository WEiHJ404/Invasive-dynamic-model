...
# PARAMETERS --------------------------------------------------------------
rm(list = ls())
beta <- read.xlsx('/Users/weihj/Desktop/工作/2022/0405/苏州/苏州参数.xlsx', sheet = 3, cols = 1:4, colNames = T)
b <- c(beta$b)
h <- c(beta$h)
bb <- c(beta$bb)
t1 <- seq(4, 20, 2)
...
for (t in t1) {
  for (i in seq_along(b)) {
    ...
    write.xlsx(out, paste0("/Users/weihj/Desktop/工作/2022/0413/苏州/bh/",t, "/", b[i], '_', h[i], '.xlsx'),overwrite = TRUE)
    rm(out)
