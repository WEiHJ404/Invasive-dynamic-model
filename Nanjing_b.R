...
# PARAMETERS --------------------------------------------------------------
rm(list = ls())
beta <- read.xlsx('/Users/weihj/Desktop/工作/2022/0405/南京/南京参数.xlsx', sheet = 1, cols = 1:3, colNames = T)
b <- c(beta$b)
h <- c(beta$h)
bb <- c(beta$bb)
t1 <- seq(6, 22, 2)
...
for (t in t1) {
  ...
  for (i in seq_along(b)) {
    ...
    write.xlsx(out, paste0("/Users/weihj/Desktop/工作/2022/0413/南京/b/",t, "/", b[i], '.xlsx'),overwrite=TRUE)
    rm(out)
